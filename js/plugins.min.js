 ...
 **/
!function(s){"use strict";s.fn.tabs=function(a){a=s.extend({mode:"fade",anchors:!1,duration:400,"class":"selected"},a);var t=s("html, body"),i=window.location.hash;return this.each(function(){var e=s(this),n=e.find("li:first a"),l=null,d=null;!0===a.anchors&&""!==i&&e.find('a[data-toggle="tab"]')&&(n=e.find('a[href="/'+i+'"]')),n.parent().addClass(a["class"]),l=n.attr("href").split("/")[1],s(l).show().siblings().hide(),e.on("click",'a[data-toggle="tab"]',function(i){if(d=s(this).attr("href").split("/")[1],d!=l){switch(a.mode){case"slide":s(d).siblings().slideUp(),s(d).delay(a.duration).slideDown();break;default:s(d).fadeIn(a.duration).siblings().hide()}s(this).parent().addClass(a["class"]).siblings().removeClass(a["class"]),l=d}a.anchors?setTimeout(function(){t.scrollTop(0,0)},1):i.preventDefault()})}),this}}(jQuery);
 ...
 **/
!function(t){"use strict";t.fn.scrollOffset=function(e){return e=t.extend({offset:0,speed:400},e),this.each(function(){var f=t(this),n=f.attr("href"),o=t(n).offset().top,s=o-e.offset,c=e.speed,i=t("html, body");f.on("click",function(t){i.animate({scrollTop:s},c),t.preventDefault()})}),this}}(jQuery);
