...
!function(a,t,e,n,o,r,i){a.GoogleAnalyticsObject=o,a[o]=a[o]||function(){(a[o].q=a[o].q||[]).push(arguments)},a[o].l=1*new Date,r=t.createElement(e),i=t.getElementsByTagName(e)[0],r.async=1,r.src=n,i.parentNode.insertBefore(r,i)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-37604272-1","auto"),ga("send","pageview");var emmanuelb=function(a,t){"use strict";var e=function(){var t=window.location.pathname.split("/"),e=t[1],n=window.location.hash,o="navigation-main__item--current",r=a("#main-menu"),i=r.find('a[href="/#accueil"]').parent(),l=r.find('a[href="/#portfolio"]').parent(),s=r.find('a[href="/blog/"]').parent(),c=r.find('a[href="/#contact"]').parent();if(i.find("a").attr("data-toggle","tab").attr("href","#accueil"),l.find("a").attr("data-toggle","tab").attr("href","#portfolio"),c.find("a").attr("data-toggle","tab").attr("href","#contact"),"blog"===e)s.addClass(o);else switch(a.fn.tabs&&r.tabs({anchors:!0,"class":o}),n){case"#accueil":i.addClass(o);break;case"#portfolio":l.addClass(o);break;case"#contact":c.addClass(o);break;default:i.addClass(o)}},n=function(a,t){var e="dialog--"+a.type,n="dialog--open";t.find(".dialog__header").html(a.title),t.find(".dialog__body").html(a.content),t.delay(400).addClass(e+" "+n)},o=function(t){a(this).parents(".dialog").removeClass("dialog--open dialog--alert dialog--success"),t.preventDefault()},r=function(t,e,n){return a.ajax({type:t,url:e,data:n,datatype:"json"})},i=function(t){var e=a(".contact-alerts .dialog"),o=a(this).attr("method"),i=a(this).attr("action"),l=a(this).serialize(),s=a("#name"),c=a("#email"),d=a("#message"),f=s.val(),u=c.val(),m=d.val();r(o,i,l).done(function(t){var o=JSON.parse(t);"success"===o.type&&(a(".form-group").removeClass("form-group--focus form-group--label"),s.val(""),c.val(""),d.val("")),n(o,e)}).fail(function(a){var t=JSON.parse(a);s.val(f),c.val(u),d.val(m),n(t,e)}),t.preventDefault()},l=function(t){var e=a(this).attr("href");window.open(e,"width=700","height=500","menubar=0","location=0","status=0"," scrollbars=0"),t.preventDefault()},s=function(){e(),a("#contact-form").modernForm(),a(".search-form").modernForm(),a(".comment-form").modernForm(),a("#contact-form").on("submit",i),a('[data-link="share"]').on("click",l),a(".contact-alerts").on("click",".dialog__close",o),a(".back-top").scrollOffset()};return{init:s}}(jQuery);$(function(){emmanuelb.init()});
