 ...
 * JS principal
 */
var emmanuelb;!function(a,t,e,n,o,i,l){a.GoogleAnalyticsObject=o,a[o]=a[o]||function(){(a[o].q=a[o].q||[]).push(arguments)},a[o].l=1*new Date,i=t.createElement(e),l=t.getElementsByTagName(e)[0],i.async=1,i.src=n,l.parentNode.insertBefore(i,l)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-37604272-1","auto"),ga("send","pageview"),emmanuelb=function(a){"use strict";var t,e,n,o,i,l,r,s;return i=function(){var t,e,n,o,i,l,r,s,c;if(r=window.location.pathname.split("/"),c=r[1],s=window.location.hash,l="navigation-main__item--current",t=a("#main-menu"),e=t.find('a[href="/#accueil"]').parent(),i=t.find('a[href="/#portfolio"]').parent(),n=t.find('a[href="/blog/"]').parent(),o=t.find('a[href="/#contact"]').parent(),e.find("a").attr("data-toggle","tab").attr("href","#accueil"),i.find("a").attr("data-toggle","tab").attr("href","#portfolio"),o.find("a").attr("data-toggle","tab").attr("href","#contact"),"blog"===c)n.addClass(l);else switch(a.fn.tabs&&t.tabs({anchors:!0,"class":l}),s){case"#accueil":e.addClass(l);break;case"#portfolio":i.addClass(l);break;case"#contact":o.addClass(l);break;default:e.addClass(l)}},n=function(a,t){var e,n;n="dialog--"+a.type,e="dialog--open",t.find(".dialog__header").html(a.title),t.find(".dialog__body").html(a.content),t.delay(400).addClass(n+" "+e)},e=function(t){a(this).parents(".dialog").removeClass("dialog--open dialog--alert dialog--success"),t.preventDefault()},t=function(t,e,n){return a.ajax({type:t,url:e,data:n,datatype:"json"})},l=function(e){var o,i,l,r,s,c,d,f,u,m;o=a(".contact-alerts .dialog"),c=a(this).attr("method"),s=a(this).attr("action"),m=a(this).serialize(),r=a("#name"),i=a("#email"),l=a("#message"),f=r.val(),u=i.val(),d=l.val(),t(c,s,m).done(function(t){var e;e=JSON.parse(t),"success"===e.type&&(a(".form-group").removeClass("form-group--focus form-group--label"),r.val(""),i.val(""),l.val("")),n(e,o)}).fail(function(a){var t;t=JSON.parse(a),r.val(f),i.val(u),l.val(d),n(t,o)}),e.preventDefault()},s=function(t){var e,n;e=a(".skill__item"),n=e.attr("data-skill"),setTimeout(function(){e.addClass("skill__item--animation")},t)},r=function(t){var e;e=a(this).attr("href"),window.open(e,"width=700","height=500","menubar=0","location=0","status=0"," scrollbars=0"),t.preventDefault()},o=function(){i(),s(600),a(".modern-form").modernForm(),a("#contact-form").on("submit",l),a('[data-link="share"]').on("click",r),a(".contact-alerts").on("click",".dialog__close",e),a(".back-top").scrollOffset()},{init:o}}(jQuery),$(function(){emmanuelb.init()});
