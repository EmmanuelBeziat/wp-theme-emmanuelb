 ...
 **/
!function(t,s,n,e){"use strict";var i="modernForm",a={inputSelector:".form-input",classFocus:"form-group--focus",classLabel:"form-group--label"},u=function(s,n){this.element=s,this.settings=t.extend({},a,n),this._defaults=a,this._name=i,this.init()};t.extend(u.prototype,{init:function(){var s=this,n=s.settings,e=t(s.element).find(n.inputSelector);e.on({focus:function(t){s.focusInput(t)},blur:function(t){s.blurInput(t)}}).each(function(){""!==t(this).val()&&t(this).parent().addClass(n.classLabel)})},focusInput:function(s){t(s.target).parent().addClass(this.settings.classFocus+" "+this.settings.classLabel)},blurInput:function(s){var n=t(s.target).parent();""===t(s.target).val()&&n.removeClass(this.settings.classLabel),n.removeClass(this.settings.classFocus)}}),t.fn[i]=function(s){return this.each(function(){t.data(this,"plugin_"+i)||t.data(this,"plugin_"+i,new u(this,s))})}}(jQuery,window,document);
/*!
