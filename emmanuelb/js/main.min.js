 ...
 **/
!function(t,s,n,e){"use strict";var i="modernForm",a={inputSelector:".form-input",classFocus:"form-group--focus",classLabel:"form-group--label"},u=function(s,n){this.element=s,this.settings=t.extend({},a,n),this._defaults=a,this._name=i,this.init()};t.extend(u.prototype,{init:function(){var s=this,n=s.settings,e=t(s.element).find(n.inputSelector);e.on({focus:function(n){s.focusInput(t(n.target))},blur:function(n){s.blurInput(t(n.target))}}).each(function(){""!==t(this).val()&&t(this).parent().addClass(n.classLabel)})},focusInput:function(t){t.parent().addClass(this.settings.classFocus+" "+this.settings.classLabel)},blurInput:function(t){var s=t.parent();""===t.val()&&s.removeClass(this.settings.classLabel),s.removeClass(this.settings.classFocus)}}),t.fn[i]=function(s){var n;t.data(this,"plugin_"+i)!==!0&&(n=new u(this,s),t.data(this,"plugin_"+i,!0))}}(jQuery,window,document);
/*!
 ...
 **/
!function(t,i,n,e){"use strict";var s="scrollOffset",o={offset:0,duration:400},a=function(i,n){this.element=i,this.settings=t.extend({},o,n),this.body=t("html, body"),this._defaults=o,this._name=s,this.init()};t.extend(a.prototype,{init:function(){var i=this;t(i.element).on("click",function(n){i.animate(i.body,t(n.target).attr("href")),n.preventDefault()})},animate:function(i,n){i.animate({scrollTop:t(n).offset().top-this.settings.offset},this.settings.duration)}}),t.fn[s]=function(i){var n;t.data(this,"plugin_"+s)!==!0&&(n=new a(this,i),t.data(this,"plugin_"+s,!0))}}(jQuery,window,document);
/*!
 ...
 **/
!function(t,s,i,n){"use strict";var e="tabs",a={mode:"fade",anchors:!1,duration:400,"class":"selected"},l=function(s,i){this.element=s,this.settings=t.extend({},a,i),this._defaults=a,this._name=e,this._body=t("html, body"),this.init()};t.extend(l.prototype,{init:function(){var i=this,n=i.settings,e=t(i.element),a=e.find("li:first a"),l=null,d=s.location.hash,o=null;n.anchors&&""!==d&&e.find('a[data-toggle="tab"]')&&(a=e.find('a[href="'+d+'"]')),a.parent().addClass(i.settings["class"]),l=a.attr("href"),t(l).show().siblings().hide(),e.on("click",'a[data-toggle="tab"]',function(s){if(o=t(this).attr("href"),o!=l){switch(n.mode){case"slide":t(o).siblings().slideUp(),t(o).delay(n.duration).slideDown();break;default:t(o).fadeIn(n.duration).siblings().hide()}t(this).parent().addClass(n["class"]).siblings().removeClass(n["class"]),l=o}!0===n.anchors?setTimeout(function(){i._body.scrollTop(0,0)},1):s.preventDefault()})}}),t.fn[e]=function(s){return this.each(function(){var i;t.data(this,"plugin_"+e)!==!0&&(i=new l(this,s),t.data(this,"plugin_"+e,!0))})}}(jQuery,window,document);
/*!
 * JS principal
 */
var emmanuelb;!function(a,t,e,n,o,i,r){a.GoogleAnalyticsObject=o,a[o]=a[o]||function(){(a[o].q=a[o].q||[]).push(arguments)},a[o].l=1*new Date,i=t.createElement(e),r=t.getElementsByTagName(e)[0],i.async=1,i.src=n,r.parentNode.insertBefore(i,r)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-37604272-1","auto"),ga("send","pageview"),emmanuelb=function(a){"use strict";var t,e,n,o,i,r,l,s;return i=function(){var t,e,n,o,i,r,l,s,c;if(l=window.location.pathname.split("/"),c=l[1],s=window.location.hash,r="navigation-main__item--current",t=a(".navigation-main"),e=t.find('a[href="/#accueil"]').parent(),i=t.find('a[href="/#portfolio"]').parent(),n=t.find('a[href="/blog/"]').parent(),o=t.find('a[href="/#contact"]').parent(),e.find("a").attr("data-toggle","tab").attr("href","#accueil"),i.find("a").attr("data-toggle","tab").attr("href","#portfolio"),o.find("a").attr("data-toggle","tab").attr("href","#contact"),"blog"===c)n.addClass(r);else switch(a.fn.tabs&&t.tabs({anchors:!0,"class":r}),s){case"#accueil":e.addClass(r);break;case"#portfolio":i.addClass(r);break;case"#contact":o.addClass(r);break;default:e.addClass(r)}},n=function(t,e){var n,o;o="dialog--"+t.type,n="dialog--open",e.find(".dialog__header").html(t.title),e.find(".dialog__body").html(t.content),e.delay(400).addClass(o+" "+n),a(".site").addClass("de-emphasized")},e=function(t){a(this).parents(".dialog").removeClass("dialog--open dialog--alert dialog--success"),a(".site").removeClass("de-emphasized"),t.preventDefault()},t=function(t,e,n){return a.ajax({type:t,url:e,data:n,datatype:"json"})},r=function(e){var o,i,r,l,s,c,d,f,u,m;o=a(".contact-alerts .dialog"),c=a(this).attr("method"),s=a(this).attr("action"),m=a(this).serialize(),l=a("#name"),i=a("#email"),r=a("#message"),f=l.val(),u=i.val(),d=r.val(),t(c,s,m).done(function(t){var e;e=JSON.parse(t),"success"===e.type&&(a(".form-group").removeClass("form-group--focus form-group--label"),l.val(""),i.val(""),r.val("")),n(e,o)}).fail(function(a){var t;t=JSON.parse(a),l.val(f),i.val(u),r.val(d),n(t,o)}),e.preventDefault()},s=function(t){var e,n;e=a(".skill__item"),n=e.attr("data-skill"),setTimeout(function(){e.addClass("skill__item--animation")},t)},l=function(t){var e,n,o,i,r,l,s;s=a(this).attr("data-url"),e=window.screenLeft||window.screenX,l=window.screenTop||window.screenY,r=640,n=480,o=e+window.innerWidth/2-r/2,i=l+window.innerHeight/2-n/2,window.open(s,"Partager","width="+r+", height="+n+", menubar=0, location=0, scrollbars=yes, left="+o+", top="+i+", status=0"),t.preventDefault()},o=function(){i(),s(600),a(".modern-form").modernForm(),a("#contact-form").on("submit",r),a('[data-link="share"]').on("click",l),a(".contact-alerts").on("click",".dialog__close",e),a(".back-top").scrollOffset()},{init:o}}(jQuery),$(function(){emmanuelb.init()});
